...
public class ReadingProperties {
    ...
    public void reading_from_properties_test() throws IOException {
        ...
        // 1.step: Create the object of Properties
        Properties properties = new Properties();

        // 2.step: We need to open the file in java memory: FileInputStream
        FileInputStream file= new FileInputStream("configuration.properties");

        //3.step: Load the properties object using FileInputStream object
